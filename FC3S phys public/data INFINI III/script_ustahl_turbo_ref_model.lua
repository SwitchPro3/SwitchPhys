...
--- If you're using CSP older than 0.2.5 then comment line 126 (with '--')
--- and uncomment line 125 (by removing '--')
...
local function adjustTurboRefRPMByGear(gear)
    ...
    for i = 1, detected_turbo_count, 1 do
        ...
        ac.setTurboExtras2(i - 1, lag_up, lag_dn, ref_rpm, gamma)
    end
    gear_changed = false
end
...
local ustahl_turbo_ref_model = {}

function ustahl_turbo_ref_model.runTurboRefModel()
    mainLoop()
end

return ustahl_turbo_ref_model